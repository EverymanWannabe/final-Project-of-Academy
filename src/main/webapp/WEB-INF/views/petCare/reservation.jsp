...
<script src="//t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script> <!-- 주소 api -->
    ...
    <style>
        ...
        .duration-btn:hover, .petType-btn:hover {
            background-color: #ffb74d;
            color: #ffffff;
        }
    ...
    <div class="container" id="formBody">
        ...
        <form action="enroll.re" method="post" enctype="multipart/form-data">
            ...
            <div class="form-section">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">주소 신규입력</button>
                <div class="form-group">
            ...
            <div class="form-section">
                ...
                <p>(일정 변경은 이전 페이지에서 가능합니다.)</p> <button id="homeBtn" class="btn btn-primary" onclick="location.href='sitter.re'">예약 초기화면으로 돌아가기</button>
            ...
            <br>
            <button type="submit" class="btn-reserve">예약완료 결제하기로 이동</button>
        </form>
    </div> 	
